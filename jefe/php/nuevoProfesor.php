...
include("./encrypt.php"); // Incluir las funciones de encriptación y desencriptación
...
$email = $_POST['email'];
$id_nivel_acceso = 1; // nivel de acceso para profesores
$recien_creado = 1;
...
// Comprobar si se seleccionó alguna carrera
if (count($carreras) == 0) {
    echo json_encode([
        'status' => 'error',
        'icon' => 'error',
        'message' => 'No se ha seleccionado una carrera para el profesor nuevo',
        'title' => 'Selecciona una carrera para el profesor'
    ]);
    exit();
    die();
}
