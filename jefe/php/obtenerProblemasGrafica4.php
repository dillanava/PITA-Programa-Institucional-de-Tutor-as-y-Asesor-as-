...
$conditions1 = "WHERE YEAR(c.fecha) = $anio AND c.periodo = $periodo AND c.id_citasN = 4";
$conditions2 = !empty($anio2) && !empty($periodo2) ? "WHERE YEAR(c.fecha) = $anio2 AND c.periodo = $periodo2 AND c.id_citasN = 4" : null;
