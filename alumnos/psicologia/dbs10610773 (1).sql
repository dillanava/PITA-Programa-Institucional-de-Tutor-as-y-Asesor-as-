...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-06-2024 a las 21:12:52
...
('Bermeo Nava Dillan', 13201305189, '2MSC1', '2', 9, 1, 0, '+5rEhKeJVXYuE0rJqqpVV6YMNl9FrujaWJQWt+UoEcH6M8NyWDwMEZVAHtQf8I51+2bwxSN6LEEtUId63e8c/Q==', 1, '13201305189@gmail.com', NULL, 'Matutino', 0, 2024, 0, 2, 1),
('José Luis Saucedo Fernández', 13211405309, '1VSC', '1', 0, 1, 0, 'EkPOsb2TNdy9BIWLxYVfm50S5Rgn066taN25lz5WEZLzV+bg7RZFwZn0/gDCmqe3IF7hhMZy97D4hrTMDsZZCQ==', 1, '132114053093@uptex.edu.mx', NULL, 'Vespertino', 1, 2023, 1, NULL, 2);
...
(1575, 13201305189, 23, 0),
(1576, 13201305189, 24, 0),
(1577, 13201305189, 25, 0),
(1578, 13201305189, 26, 0),
(1579, 13201305189, 27, 0),
(1580, 13201305189, 28, 0),
(1581, 13201305189, 29, 0),
...
(44, 1, 'qrPA4d/YJ1LiXUfC+49hia9ZF0N7kMJI3lV6jmopRAT7XcOUp4BoQ6J3MscyD+FVHu0YRWAtnBtu/H/txUIAJQ==', 'FIaEINLMbfiX1BGoDmfKXYW4dQ6T4/TUg9m5wnTQwi/15PPAK7dWoaX1asdJ3Gsrqkypb8jhpE51TG5pg3iCyvnvfdrurMZKBzAfaG77DNmSc0FaVqemh9G0P94s5Biw'),
...
(48, 1, 'f5kmXqb1SFzjbwYPcilNaPwwQVQg7czKgWLXUfoN9mDvLLVUKiKasmW/SyA78lqBDHMrBtdQd8UYIXzzlsijbQ==', '6SGe5KMYHdK8g8nljsTLkk5DQExtRA/DrFHE4LnXNcUAGcQJanZYgMSSxdxwFqgdKcinQxrBeB4Ou91ZMG/DcA==');
...
('Héctor Manuel Gómez Martínez', 1, 5, 1, 'E2jNahV2kvB4d8Jops/f1Eo7LLGYWwN98Eopa5RakPj9kgev9RKe6WMERJpSRDWWHZrNqATPsQWEsDV6OgJvxg==', 'rector@uptex.edu.mx', NULL, 0),
...
('Jesús Román Fuentes Ruíz', 35753, 4, 1, 'jYwMNs4eK+woXTlljqVjItuHd4HsrCsF/1nEJ7z9fjEskBGlHRU8SM29PXEEQNpwY4jhbAD+1itrWS+GomuEnA==', 'roman.fuentes@uptex.edu.mx', NULL, 0),
('Ángel David Barrera García', 53423, 1, 1, 'nh84tbRDhREDl8Ny9R55S9BTHT9pN+TGdnLNqARoayXuInAMRLZ8z5Xyof7CNK/sgjCU5SoN+s6H0EuYd5/XGQ==', 'angel@hotmail.com', NULL, 0),
...
('Osiriz Marlen Trujillo López', 94638, 3, 1, 'SMyBaEO7xgCKS6kSErslSOJ+L7dFfno2HoUmGQYNaDpi3fl6IWTC1H3vhEHxz8mawLwLW6a6oC1dfjQsDP7aMA==', 'osiriz.trujillo@uptex.edu.mx', NULL, 0),
...
--
ALTER TABLE `asignaturasa`
  MODIFY `id_asignaturasa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1610;
...
--
ALTER TABLE `mensajes`
  MODIFY `id_mensaje` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=997;
