...
function getEmailTemplate($logoUrl, $logopita, $codigo, $numerousuario) {
    ...
    <body>
        <div class='email-container'>
            ...
            <div class='content'>
                <h3>Estimado usuario, $numerousuario</h3>
                <p>Estamos enviándote este correo electrónico porque hemos recibido una solicitud de cambio de contraseña para tu cuenta en la plataforma de la <b>Programa Integral de Tutorías y Asesorías</b>. Si tú no has realizado esta solicitud, por favor ignora este mensaje y considera cambiar tu contraseña por seguridad.</p>
