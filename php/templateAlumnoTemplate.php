...
function usuarioNuevoTemplate($logoUrl, $logopita, $nombre) {
...
$random_frase_motivacion = $frases_motivacion[array_rand($frases_motivacion)];
    ...
    <body>
        <div class='email-container'>
            ...
            <div class='content'>
                	<h1>!Bienvenid@ a PITA¡</h1>
                <h3>Ya puedes acceder a todas las funciones, $nombre </h3>
                <p>¡Nos alegra tenerte como parte de nuestra comunidad en la plataforma <b>Programa Integral de Tutorías y Asesorías</b>!</p>
                <p>Gracias por ser parte de nuestra comunidad. Ahora podrás acceder a nuevas funciones como:</p>
                <ul>
                    <li>Ver tus materias</li>
                    <li>Ver el historial de tus calificaciones</li>
                    <li>Agendar citas con tutor</li>
                    <li>Ver el historial de tus citas</li>
                    <li>Ver el estado de tus citas</li>
                </ul>         
                <br>       
